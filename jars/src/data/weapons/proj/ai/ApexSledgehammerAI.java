...
public class ApexSledgehammerAI implements MissileAIPlugin, GuidedMissileAI
{
    // an adaptation of magiclib's missile ai with some anti-clumping code
    ...
    private final boolean ANTI_CLUMP = true;
    ...
    public ApexSledgehammerAI(MissileAPI missile, ShipAPI launchingShip)
    {
