...
public class ApexGuidedTorpAI implements MissileAIPlugin, GuidedMissileAI
{
    ...
    private float ECCM = 1f;   //A VALUE BELOW 1 WILL PREVENT THE MISSILE FROM EVER HITTING ITS TARGET!
    ...
    public ApexGuidedTorpAI(MissileAPI missile, ShipAPI launchingShip)
    {
